...
/* Rezos Command line interface - Local Storage for Configuration */
...
module Alias = functor (Entity : Entity) => {
  ...
  let dirname cctxt = cctxt.config.base_dir;

  let filename cctxt = Filename.concat (dirname cctxt) (Entity.name ^ "s");
